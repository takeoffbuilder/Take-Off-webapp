                ...
                <div className="w-full h-full bg-gray-900 rounded-[2.5rem] overflow-hidden relative">
                  ...
                  <div className="px-6 py-3 pb-20">
                    <div className="text-center mb-5">
                      <h2 className="text-lg font-semibold mb-2 text-white">Your Credit Score</h2>
                      <div className="relative w-24 h-24 mx-auto mb-3">
                        <svg className="w-24 h-24 transform -rotate-90" viewBox="0 0 120 120">
                          <circle cx="60" cy="60" r="45" stroke="#374151" strokeWidth="6" fill="none" />
                          <circle
                            cx="60"
                            cy="60"
                            r="45"
                    ...
                    <div className="text-center mb-3">
                      <p className="text-xs text-gray-400 mb-2">Specialized reported tradeline</p>
                    ...
                    <div className="mb-3">
                      <p className="text-center text-sm font-medium text-white mb-1">Tri-bureau reporting</p>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-300">Improve key credit factors</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-300 font-medium">Increase your scores fast</span>
                        <div className="flex gap-8">
                          <div className="w-4 h-4 rounded-full bg-sky-500 flex items-center justify-center">
                            <svg className="w-2.5 h-2.5 text-white" fill="currentColor" viewBox="0 0 20 20">
                              <path
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Enter Your Email</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Choose Your Plan</h3>
              <p className="text-gray-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Watch It Grow</h3>
              <p className="text-gray-400">Track your credit score improvements in real-time on your dashboard.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-gray-800">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <div className="flex justify-center">
            <div className="relative w-72 h-[600px] bg-gray-700 rounded-[3rem] p-2">
              <div className="w-full h-full bg-gray-900 rounded-[2.5rem] overflow-hidden">
                ...
                <div className="px-6 py-6">
                  ...
                  <div className="flex gap-2 mb-8">
                    ...
                    <button className="flex-1 py-3 px-6 rounded-full border-2 border-gray-600 text-gray-400 font-medium">
                      Premium
                    </button>
                  </div>
                  ...
                  <div className="text-center mb-6">
                    <p className="text-sm text-gray-400 mb-4">Specialized reported tradeline</p>
                  ...
                  {/* Tri-bureau reporting */}
                  <div className="mb-6">
                    <p className="text-center text-sm font-medium text-white mb-2">Tri-bureau reporting</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-300">Rent Reporting</span>
                      <div className="flex gap-8">
                        <div className="w-5 h-5 rounded-full bg-gray-600 flex items-center justify-center">
                          <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path
      ...
      <section className="py-16 md:py-24 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-light text-gray-400 mb-4">Helping credit builders score.</h2>
          ...
          <div className="space-y-8 max-w-2xl mx-auto">
            {/* Proven Results Card */}
            <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 text-white">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                <span className="font-bold text-white">+84pts</span> in just a year with on-time payments
            ...
            <div className="bg-gray-900 border border-gray-700 rounded-2xl p-8 text-white">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-xl font-semibold text-white">Trusted by bureaus</h4>
              </div>
              <p className="text-gray-300 leading-relaxed">
                The power of Tri-bureau: Take Off reports to all 3 major credit bureaus:{" "}
                <span className="font-bold text-white">Equifax, Experian, & TransUnion</span>.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 bg-gray-800 border-t border-gray-700">
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="text-xs text-gray-400 leading-relaxed space-y-4">
            ...
            <p className="pt-4 border-t border-gray-600 text-center text-gray-500">
